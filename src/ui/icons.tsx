...
export const ICONS: Record<string, ReactNode> = {
  ...
  probe: <>{C(10.5, 10.5, 6.5)}{P('M15.5 15.5L21 21')}{P('M11.8 6.5l-3 4h2.4l-1 3.5 3.4-4.5h-2.4z')}</>,
  ...
  sun: (
    <>
      {C(12, 12, 4.2)}
      {P('M12 2.5v3M12 18.5v3M2.5 12h3M18.5 12h3M5.3 5.3l2.1 2.1M16.6 16.6l2.1 2.1M18.7 5.3l-2.1 2.1M7.4 16.6l-2.1 2.1')}
    </>
  ),
  moon: <>{P('M20 13.5A8 8 0 0110.5 4 8 8 0 1020 13.5z')}</>,
  palette: (
    <>
      {C(12, 12, 9)}
      {C(8.6, 9.4, 1.35, true)}
      {C(14.8, 8.2, 1.35, true)}
      {C(16.4, 13.4, 1.35, true)}
      {C(10.4, 15.6, 1.35, true)}
    </>
  ),
  eye: (
    <>
  ...
  // «генератор»: указка с искрами — из строки текста получается деталь
  gen: <>{P('M3.5 20.5l9.5-9.5')}{P('M13 3.2l.9 2.2 2.2.9-2.2.9-.9 2.2-.9-2.2-2.2-.9 2.2-.9z')}{P('M18.6 12.4l.6 1.5 1.5.6-1.5.6-.6 1.5-.6-1.5-1.5-.6 1.5-.6z')}</>,
};
