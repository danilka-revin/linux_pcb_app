...
export const ICONS: Record<string, ReactNode> = {
  ...
  preview2d: <>{R(3, 4, 18, 14, 2)}{P('M3 8h18M7 12h3M12 12h3M17 12h1M7 16h10')}{C(12, 12, 0, true)}</>,
  // единая кнопка предпросмотра: плата с «глазом» внутри
  preview: (
    <>
      {R(2.5, 3.5, 19, 17, 2.5)}
      {P('M7 12s2.1-3.1 5-3.1S17 12 17 12s-2.1 3.1-5 3.1S7 12 7 12z')}
      {C(12, 12, 1.9, true)}
    </>
  ),
  caret: <>{P('M7 10l5 5 5-5')}</>,
  preview3d: <>{P('M12 3L3 8v8l9 5 9-5V8z')}{P('M3 8l9 5 9-5')}{P('M12 13v8')}</>,
  cube: <>{P('M12 3L3 8v8l9 5 9-5V8z')}{P('M3 8l9 5 9-5')}{P('M12 13v8')}</>,
  layers: <>{R(3, 4, 18, 3, 1)}{R(3, 9, 18, 3, 1)}{R(3, 14, 18, 3, 1)}</>,
};
