...
- **Экспорт для фрезерного ЧПУ** (Файл → ⋯ → «G-code для фрезерного станка…», либо
  ...
  В диалоге задаются диаметр фрезы, зазор, подачи/обороты, глубины, безопасный Z,
  рабочие отступы платы и сторона сверления; перед скачиванием — превью с проверкой
  зазоров. Параметры по умолчанию не гарантируют безопасность на вашем станке.
