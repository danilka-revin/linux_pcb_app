...
- **Автотрассировка** (инструмент «Автотрассировка», клавиша `9`): клик по первой
  ...
  **Приоритет — нижний слой K2 (сторона пайки):** в отверстия выводных площадок дорожка
  всегда входит по низу, а для обхода препятствий может уходить на верх (K1) через переходные
  отверстия. Два отдельных зазора: **до чужих дорожек** и **до отверстий** (площадки с
