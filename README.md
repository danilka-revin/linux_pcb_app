...
- Предпросмотр макроса в библиотеке: фон с сеткой, точка привязки (0;0),
  габаритная рамка с размерами в мм и масштабная линейка; предпросмотр в диалоге
  сетки показывает ровно настроенный шаг с подразбиением и «главными» линиями
